...
**You can download this qmd file [here](https://github.com/solveigsenf/SDS264/blob/main/Projects/04_mini_project/04_mini_project.qmd).**
...
First, I clean the data, making a few different data frames for different text analysis purposes. To do so, I make use of multiple str\_ functions: str_to_lower, str_view, str_replace_all, and str_to_title.
